...
@Module({
  imports: [ConfigModule.forRoot({ isGlobal: true, envFilePath: ['../.env', '.env'] }), AppConfigurationModule, PrismaModule, AuthenticationModule, CandidatePortalModule, CompanyIntelligenceModule, JobCrawlingModule],
