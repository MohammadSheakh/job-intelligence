...
/** Canonicalize legacy English matching signals while preserving technical punctuation. */
...
/** Split legacy free-text profile lists using their accepted separators. */
