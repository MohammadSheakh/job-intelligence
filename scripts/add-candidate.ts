...
try {
  ...
  console.log(JSON.stringify({ candidateId: id, email, defaultPasswordAssignedIfMissing: true, mustChangePassword: true }, null, 2));
} finally {
  await closeDb();
}
